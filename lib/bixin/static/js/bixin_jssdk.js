...
var ApiNames = {
  config: "config",
  openPay: "openPay",
  openC2bPay: "openC2bPay",
  openC2bDeposit: "openC2bDeposit",
...
bixin = {
  ...
  openC2bPay: function(data){
    invoke(ApiNames.openC2bPay, getOpenPayParams(data), data);
  },
  openC2bDeposit: function(data){
    invoke(ApiNames.openC2bDeposit, getOpenPayParams(data), data);
  },
